...
const singleLineLinks = minimizedLinks.join("?");

// Self test. Splitting should give the same number of links.
const testLinks = singleLineLinks.split("?");
...
fs.writeFileSync(minimizeCharacterLinksFile, JSON.stringify({ singleLineData: singleLineLinks }));